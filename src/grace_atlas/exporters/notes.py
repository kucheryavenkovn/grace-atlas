...
TAG_BY_TYPE: dict[str, str] = {
    NodeType.REQUIREMENT: "grace/requirement",
    NodeType.USE_CASE: "grace/use-case",
    NodeType.MODULE: "grace/module",
    NodeType.VERIFICATION: "grace/verification",
    NodeType.CRITICAL_FLOW: "grace/flow",
    NodeType.DATA_FLOW: "grace/flow",
    NodeType.PHASE: "grace/phase",
    NodeType.STEP: "grace/step",
    NodeType.OPERATIONAL_PACKET: "grace/packet",
    NodeType.SOURCE_FILE: "grace/file",
    NodeType.TEST_FILE: "grace/test",
    NodeType.CONTRACT: "grace/contract",
    NodeType.SEMANTIC_BLOCK: "grace/block",
    NodeType.TECHNOLOGY: "grace/technology",
    NodeType.EVIDENCE: "grace/evidence",
    NodeType.CONSTRAINT: "grace/constraint",
    NodeType.RISK: "grace/risk",
    NodeType.NON_GOAL: "grace/non-goal",
    NodeType.PHASE_GATE: "grace/gate",
    NodeType.DEPLOYMENT: "grace/deployment",
    NodeType.ACTOR: "grace/actor",
}
