...
Obsidian Graph View + Canvas generated by GRACE Atlas (screen capture):

![GRACE Atlas demo](docs/assets/demo.gif)

<details>
<summary>Higher-quality MP4 (optional)</summary>

[demo-preview.mp4](docs/assets/demo-preview.mp4) — compressed H.264 preview of the same session.
